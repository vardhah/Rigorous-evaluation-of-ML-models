...
class ddpgAgent():
    def __init__(self, Testing=False):
        ...
        try:
            self.actor.model.load_state_dict(torch.load("./models/controller/actor2000.pt"))
            self.actor.target_model.load_state_dict(torch.load("./models/controller/actor2000.pt"))
